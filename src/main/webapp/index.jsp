<%@page import="com.fvq.modelo.Carrito"%>
<%@page import="com.fvq.modelo.Producto"%>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="nav-item dropdown">
                <a class="navbar-brand" style="color: white" href="#" data-toggle="dropdown"><img src="img/logo.png" width="60" height="60">Multi-Store</a>
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    <li class="nav-item active">
                        <a class="nav-link" href="./Controlador?accion=home"><i class="fas fa-home" style="color: white"></i> Tienda<span class="sr-only">(current)</span></a>
                    </li>
