...
<%@page import="com.fvq.config.Fecha"%>
...
<html>
    ...
    <body>       
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <a class="navbar-brand" href="#"><i><img src="img/logo.png" width="60" height="60"></i> Multi-Stores</a>

            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    <li class="nav-item active">
                        <a class="nav-link" href="./Controlador?accion=Nuevo"><i class="fas fa-home"></i> Tienda<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <c:if test="${subtotal!=',00'}">
                                <a class="form-control text-center"><i class="h5">Bs/. ${subtotal}</i></a>
                            </c:if>
                            <c:if test="${subtotal==',00'}">
                                <a class="form-control text-center"><i class="h5">Bs/. 0,00</i></a>
                            </c:if>                            
                            <label>Descuento:</label>
                            <c:if test="${totalDescuento!=',00'}">
                                <a class="form-control text-center"><i class="h5" style="color: red">Bs/. ${totalDescuento}</i></a>
                            </c:if>    
                            <c:if test="${totalDescuento==',00'}">
                                <a class="form-control text-center"><i class="h5" style="color: red">Bs/. 0,00</i></a>
                            </c:if>    

                            <label>IGV:</label>
                            <c:if test="${igv!=',00'}">
                                <a class="form-control text-center"><i class="h5">Bs/. ${igv}</i></a>
                            </c:if> 
                            <c:if test="${igv==',00'}">
                                <a class="form-control text-center"><i class="h5">Bs. 0,00</i></a>
                            </c:if> 
                            ...
                            <c:if test="${igv!=',00'}">
                                <a class="form-control text-center"><i class=" h4 primary">Bs/. ${totalPagar}</i></a>
                            </c:if> 
                            <c:if test="${igv==',00'}">
                                <a class="form-control text-center"><i class=" h4 primary">Bs/. 0,00</i></a>
                            </c:if> 
