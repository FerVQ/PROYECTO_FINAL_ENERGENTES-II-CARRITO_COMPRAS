...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <a class="navbar-brand"  href="#"><i><img src="img/logo.png" width="50" height="40"></i> Multi-Store</a>
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    <li class="nav-item active">
                        <a class="nav-link" href="./Controlador?accion=home"><i class="fas fa-home"></i> Tienda<span class="sr-only">(current)</span></a>
                    </li>                                 
                </ul>                                           
            </div>
        </nav>        
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="input-group mb-3">
                                ...
                                <input type="number" id="dni" name="txtDni" class="form-control" placeholder="CI">
                            </div>                                                   
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="email" name="txtCorreo" class="form-control" placeholder="correo_electronico" >
                            </div>                                                   
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="inputGroup-sizing-default"><i class="fa fa-unlock-alt"></i></span>
                                </div>
                                <input type="password" name="txtPass" class="form-control" value="contraseña">
                            </div> 
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
