package com.fvq.controlador;

import com.fvq.config.Fecha;
import com.fvq.modelo.Carrito;
import com.fvq.modelo.Categoria;
import com.fvq.modelo.Cliente;
import com.fvq.modelo.ClienteDAO;
import com.fvq.modelo.Compra;
import com.fvq.modelo.ComprasDAO;
import com.fvq.modelo.DetalleCompra;
import com.fvq.modelo.Pago;
import com.fvq.modelo.Producto;
import com.fvq.modelo.ProductoDAO;
import com.fvq.modelo.Rol;
import com.fvq.modelo.Tarjeta;
import java.io.File;
                ...
                try {
                    ...
                    for (int i = 0; i < items.size(); i++) {
                        ...
                        if (!fileItem.isFormField()) {
                            File file = new File("C:\\Users\\ASUS\\Desktop\\EJERCICIOS_EMERGENTES\\Tienda_Web_Carrito\\web\\img\\productos\\" + fileItem.getName());
                            fileItem.write(file);
                ...
                try {
                    ...
                    for (int i = 0; i < items.size(); i++) {
                        ...
                        if (!fileItem.isFormField()) {
                            ...
                            if (!"".equals(nomfoto)) {
                                File file = new File("C:\\Users\\ASUS\\Desktop\\EJERCICIOS_EMERGENTES\\Tienda_Web_Carrito\\web\\img\\fotouser\\" + fileItem.getName());
                                fileItem.write(file);
